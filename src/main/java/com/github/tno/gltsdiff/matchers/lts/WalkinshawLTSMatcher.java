...
/**
 * Matcher for {@link BaseLTS LTSs} based on landmarks, 'obviously' matching state pairs, as proposed by Walkinshaw et
 * al, thereby taking initial state information into account.
 *
 * @param <S> The type of LTS state properties.
 * @param <T> The type of transition properties.
 * @param <U> The type of LTSs.
 */
public class WalkinshawLTSMatcher<S extends LTSStateProperty, T, U extends BaseLTS<S, T>>
