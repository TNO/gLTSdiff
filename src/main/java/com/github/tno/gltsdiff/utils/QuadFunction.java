 ...
 */
@FunctionalInterface
public interface QuadFunction<T1, T2, T3, T4, TR> {
    /**
     ...
     */
    TR apply(T1 a1, T2 a2, T3 a3, T4 a4);
     ...
     */
    default <V> QuadFunction<T1, T2, T3, T4, V> andThen(final Function<? super TR, ? extends V> after) {
        Objects.requireNonNull(after);
        return (final T1 a1, final T2 a2, final T3 a3, final T4 a4) -> after.apply(apply(a1, a2, a3, a4));
    }
}
