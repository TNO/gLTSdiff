...
public class DynamicScorer<S, T, U extends GLTS<S, T>> implements SimilarityScorer<S, T, U> {
     ...
     */
    public DynamicScorer(Combiner<S> statePropertyCombiner, Combiner<T> transitionPropertyCombiner) {
    ...
    {
        SimilarityScorer<S, T, U> globalScorer = new WalkinshawGlobalScorer<>(statePropertyCombiner,
                transitionPropertyCombiner);
        SimilarityScorer<S, T, U> local5Scorer = new WalkinshawLocalScorer<>(statePropertyCombiner,
                transitionPropertyCombiner, 5);
        SimilarityScorer<S, T, U> local1Scorer = new WalkinshawLocalScorer<>(statePropertyCombiner,
