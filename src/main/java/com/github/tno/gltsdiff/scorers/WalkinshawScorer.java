...
public abstract class WalkinshawScorer<S, T, U extends GLTS<S, T>> implements SimilarityScorer<S, T, U> {
     ...
     * {@link WalkinshawLocalScorer} should be used instead, which gives the same result but is much faster. A ratio of
     * 1 would mean that far-away state similarities contribute equally much as local ones.
     * </p>
     */
